...
CREATE TABLE `ec` (
  ...
  CONSTRAINT `ec_ibfk_1` FOREIGN KEY (`COLLEGE_ID`) REFERENCES `college` (`COLLEGE_ID`)
...
INSERT INTO `ec` VALUES (1,1,'EC',50000),(2,2,'EC',50000),(3,3,'EC',50000),(4,4,'EC',50000),(5,5,'EC',50000),(6,6,'EC',50000);
