...
CREATE TABLE `automobile` (
  ...
  CONSTRAINT `automobile_ibfk_1` FOREIGN KEY (`COLLEGE_ID`) REFERENCES `college` (`COLLEGE_ID`)
...
INSERT INTO `automobile` VALUES (1,1,'AUTOMOBILE',50000),(2,2,'AUTOMOBILE',50000),(3,3,'AUTOMOBILE',50000),(4,4,'AUTOMOBILE',50000),(5,5,'AUTOMOBILE',50000),(6,6,'AUTOMOBILE',50000);
...
-- Dump completed on 2022-03-02 23:13:12
