...
CREATE TABLE `civil` (
  ...
  CONSTRAINT `civil_ibfk_1` FOREIGN KEY (`COLLEGE_ID`) REFERENCES `college` (`COLLEGE_ID`)
...
INSERT INTO `civil` VALUES (1,1,'CIVIL',50000),(2,2,'CIVIL',50000),(3,3,'CIVIL',50000),(4,4,'CIVIL',50000),(5,5,'CIVIL',50000),(6,6,'CIVIL',50000);
...
-- Dump completed on 2022-03-02 23:13:13
